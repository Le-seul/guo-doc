...
class instructor_demeanor_detail extends StatefulWidget {
  dynamic id;
  @override
  instructor_demeanor_detail({Key key,@required this.id,}) : super(key: key);

  _instructor_demeanor_detailState createState() =>
      _instructor_demeanor_detailState();
}

class _instructor_demeanor_detailState
    extends State<instructor_demeanor_detail> {
  List<PsyTeacher> Testlist = List();
  ...
  @override
  void _requestIdData() {
    DioUtils.instance.requestNetwork<PsyTeacher>(
  ...
  void _requestIdLike() {
    DioUtils.instance.requestNetwork<PsyTeacherLike>(
        Method.get, Api.PsyTeacherLike,
        queryParameters: {'id': widget.id.toString(),},
        isList: true, onSuccessList: (data) {
      setState(() {
       Testlist[0].state = data[0].state;
       Testlist[0].likeCount = data[0].likeCount;
      });
                          ...
                          child: Container(
                              ...
                              child: Container(
                                child: Row(
                                  ...
                                  children: <Widget>[
                                    Image.asset(
                                      'assets/images/consultation/心.png',
                                      height: 23,
                                      width: 23,
                                      color: Colors.orange,
                                    ),
                      ...
                      : Container(
                          ...
                          child: Container(
                            child: Row(
                              ...
                              children: <Widget>[
                                Image.asset(
                                  'assets/images/consultation/赞.png',
                                  height: 23,
                                  width: 23,
                                  color: Colors.white,
                                ),
                          ...
                          return Testlist[0].showImg[index].showId == null
                              ...
                              : InkWell(
                                  ...
                                  onTap: () {
                                    showPhoto(
                                        context,
                                        Testlist[0].showImg[index].showId,
                                        index,
                                        Testlist[0].name);
                                  },
                                );
            ...
            GestureDetector(
              child: Container(
                ...
                padding: EdgeInsets.fromLTRB(
                    ScreenUtil().setWidth(5), 15, ScreenUtil().setWidth(5), 15),
