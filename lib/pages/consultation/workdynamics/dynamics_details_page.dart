...
class WorkDetail extends StatefulWidget {
  ...
  String tag;
  bool isTopic;
  WorkDetail(this.offstage, this.tag, this.isTopic, {Key key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    // TODO: implement createState
    return _WorkDetailState(offstage);
  }
}
...
class _WorkDetailState extends State<WorkDetail> {
  ...
  _WorkDetailState(this.offstage);
...
//    Toast.show('这是上拉加载操作');
  ...
  _getTopicList(bool isRefresh) {
    DioUtils.instance.requestNetwork<ConsulationColumnsInfo>(
      Method.get,
      Api.GETARTICLETOPIC,
      queryParameters: {"topicId": widget.tag},
      isList: true,
      onSuccessList: (data) {
