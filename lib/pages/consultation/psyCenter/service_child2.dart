...
class ServiceChild2 extends StatefulWidget {
  String location = '';
  ServiceChild2(@required this.location);

  @override
  _ServiceChild2State createState() => _ServiceChild2State();
}

class _ServiceChild2State extends State<ServiceChild2> {
  ...
  _getServiceCenter() {
    print('catalog:${widget.location}');
    DioUtils.instance
        .requestNetwork<ServCenter>(Method.get, widget.location == ''?Api.GETPSYSERVICECENTERLIST:Api.GETPSYSERVICECENTERBYCATALOG,
        queryParameters: {
          'catalog': widget.location,
        },
